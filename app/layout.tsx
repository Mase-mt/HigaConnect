  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        <nav className="supports-backdrop-blur:bg-background/60 fixed left-0 right-0 top-0 z-20 border-b bg-background/30 backdrop-blur w-full flex py-2.5 px-5 justify-between">
          <div>
            <Link href={home()} className="font-bold text-lg">Home</Link>
          </div>
          <div>
            <Link href={postsPaths()} className="text-lg ">Posts</Link>
          </div>
        </nav>
